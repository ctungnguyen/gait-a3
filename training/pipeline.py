...
def train_style(
    *,
    ...
    settings_dict.update(
        {
            ...
            "selected_checkpoint": str(selected_source.relative_to(paths.output_model.parents[1])),
        }
    )
    ...
    summary = {
        ...
        "model": str(paths.output_model),
        "metadata": str(paths.metadata),
        "episode_csv": str(episode_csv),
        "tensorboard_directory": str(paths.tensorboard_dir),
        "monitor_directory": str(paths.monitor_dir),
        "periodic_evaluation_directory": str(paths.evaluation_dir),
        "settings": settings_dict,
