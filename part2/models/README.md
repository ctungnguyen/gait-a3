...
Both real `.zip` files are included and can be reproduced with
`python train_both.py`. The pipeline uses the progression reward in
`part2/arena/rewards.py`, selects the best periodic PPO
